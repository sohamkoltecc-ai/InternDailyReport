        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isAttendanceMarkedToday ? const Color(0xFFE3F2FD) : const Color(0xFF2196F3),
                      foregroundColor: _isAttendanceMarkedToday ? const Color(0xFF1565C0) : Colors.white,
                      disabledBackgroundColor: const Color(0xFFE3F2FD),
                      disabledForegroundColor: const Color(0xFF1565C0),
              ...
              Row(
                children: [
                  _buildAnalyticalCard('Current Streak', '$_currentStreak Days', Icons.bolt_rounded, const Color(0xFF1976D2)),
                  const SizedBox(width: 20),
                  _buildAnalyticalCard('Total Hours', '$_totalHours Hrs', Icons.hourglass_empty_rounded, const Color(0xFF2196F3)),
                  const SizedBox(width: 20),
                  _buildAnalyticalCard('Tasks Completed', '$_totalTasks', Icons.assignment_turned_in_rounded, const Color(0xFF03A9F4)),
                  const SizedBox(width: 20),
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: const Color(0xFF2196F3).withOpacity(0.03), blurRadius: 15, offset: const Offset(0, 5))
                        ],
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
